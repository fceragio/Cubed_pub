...
/*   Updated: 2025/07/09 16:40:02 by federico         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_north_wall_color(t_map *map, t_ray ray, t_point pixel, int y_len)
{
	...
	pixel_hit_x = ray.hit_x * TILE_SIZE;
	wall_x = pixel_hit_x % TILE_SIZE;
...
int	get_west_wall_color(t_map *map, t_ray ray, t_point pixel, int y_len)
{
	...
	pixel_hit_y = ray.hit_y * TILE_SIZE;
	wall_x = pixel_hit_y % TILE_SIZE;
