...
/*   Updated: 2025/09/28 19:34:19 by federico         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//m_pi / 2.5
# define FOV 1.5
//we recommend staying in the range 0.0005 ~ 0.0030
...
//animation spped (recommended setting: FPS / 4)
...
typedef struct s_map
{
	...
	t_sprite	*door_texture;
	t_sprite	*door_arr[DOOR_FILES];
	int			door_frame;
}	t_map;
